module.exports = function( grunt ) {
    ...
    grunt.initConfig({
        ...
        uglify : {
            ...
            my_target : {
                files : {
                    ...
                    'assets/js/template/minificados/tema_min.js' : ['assets/js/template/js_tema.js'],
                    'assets/js/template/minificados/video-gallery_min.js' : ['assets/js/template/video-gallery.js'],
                    'assets/js/template/minificados/lightbox_min.js' : ['assets/js/template/lightbox.js']
        ...
        watch: {
            ...
            scripts: {
                files: ['assets/js/template/js_tema.js', 'assets/js/template/video-gallery.js', 'assets/js/template/lightbox.js'],
        ...
        concat_css: {
            js: {
                ...
                src: [
                    ...
                    'assets/js/template/minificados/lightbox_min.js',
                    'assets/js/template/minificados/video-gallery_min.js',
                    'assets/js/template/minificadis/tema_min.js' 
                ],
