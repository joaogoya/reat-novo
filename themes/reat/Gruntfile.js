module.exports = function( grunt ) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            less: {   
                files: ['assets/css/UI-Kit/*.less', 'assets/css/UI-Kit/buttons/*.less', 'assets/css/UI-Kit/navs/*.less',    'assets/css/pages/*.less', 'assets/css/template/*.less', 'assets/css/estilo_tema.less', 'assets/css/main.css' ],
